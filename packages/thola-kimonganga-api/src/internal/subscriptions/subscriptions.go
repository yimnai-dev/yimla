...
// 		return
// 	}
// 	stripeApiKey := utils.GetEnv(utils.StripeTestApiKey)
// 	stripe.Key = stripeApiKey
// 	organisationId := chi.URLParam(r, "organisationId")
// 	params := &stripe.SubscriptionParams{
// 		Customer: stripe.String(organisationId),
// 		Items: []*stripe.SubscriptionItemsParams{
// 			&stripe.SubscriptionItemsParams{
// 				Price: stripe.String(utils.GetEnv(utils.StripePriceId)),
// 			},
// 		},
// 	}

// 	// organisationId := session.ClientReferenceID

// }

// var isDev = flag.Bool("dev", false, "Indicates if the application is running in development mode")

func GetStripePriceList(w http.ResponseWriter, r *http.Request) {
...
func GetStripeProductListWithPriceList(w http.ResponseWriter, r *http.Request) {
	stripeApiKey := utils.GetEnv(utils.StripeTestPrivateKey)
	stripe.Key = stripeApiKey
...
func GetCustomerSubscriptions(w http.ResponseWriter, r *http.Request) {
	customerId := chi.URLParam(r, "customerId")
...
func UpdatePharmacySubscriptionActiveState(w http.ResponseWriter, r *http.Request) {
