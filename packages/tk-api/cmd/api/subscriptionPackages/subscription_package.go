...
func CreateSubscriptionPackageHandler(w http.ResponseWriter, r *http.Request) {
...
func GetSubscriptionPackageHandler(w http.ResponseWriter, r *http.Request) {
...
func GetAllSubscriptionPackagesHandler(w http.ResponseWriter, r *http.Request) {
...
func DeleteSubscriptionPackageHandler(w http.ResponseWriter, r *http.Request) {
	packageId := chi.URLParam(r, "packageId")
	if packageId == "" {
		jsonRes := database.ApiError{Message: "A packageId is required", Status: http.StatusNotFound, Ok: false}
		jsonResBytes, _ := json.Marshal(jsonRes)
...
func UpdateSubscriptionPackageHandler(w http.ResponseWriter, r *http.Request) {
