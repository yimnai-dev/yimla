...
import { removeMedicationSchema, searchMedicationParametersSchema, updateMedicationSchema } from "$lib/forms/medication.form";
...
export const load = async ({ locals, cookies, fetch, setHeaders, platform }) => {
    ...
    return {
        tkp: {
            ...
            medicationListStream: getPharmacyMedicationList({ cookies, fetcher: fetch, pharmacyId: pharmacistInfoResponse.pharmacist.pharmacyId, baseURL: locals.baseURL }),
