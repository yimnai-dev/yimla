...
import { initializeCheckoutSchema, type InitializeCheckoutForm,  } from "$lib/forms/subscriptions.form";
...
export const actions = {
    initializeSubscription: async ({ request, locals, cookies, fetch }) => {
        ...
        const initializeCheckoutResponse = await post<InitializeSubscriptionSessionResponse, Omit<InitializeCheckoutForm, 'customerId'>>({
