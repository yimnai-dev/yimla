<script lang="ts">
	...
	import { stripPriceListOptions, subscriptionListOptions } from '$lib/query/subscription.query';

	let { data } = $props();

	let stripe: Stripe | null = $state(null);

	let priceListQuery = createQuery(stripPriceListOptions(data.streamed.stripePriceListStream));
