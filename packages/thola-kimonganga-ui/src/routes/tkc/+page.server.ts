...
async function medicationSearchResponse({ dosageForm, searchTerm, searchRadius, sessionKey, latitude, longitude, baseURL, userId, fetcher }: { dosageForm?: string, userId: string, searchTerm: string, searchRadius: number | undefined; sessionKey: string; baseURL: BaseURL; fetcher: typeof fetch; latitude: number; longitude: number; }) {
