...
export type SubscriptionSuffix = "price-list" | "product-price-list" | `initialize-checkout/${string}` | `pharmacies/update/${string}` | string

export type AccountSuffix = 'details' | 'update' | 'delete'

export type RequestURLSegment = 'login' | 'create' | 'email-verification' | 'forgot-password' | 'reset-password' | 'verify-session' | `pharmacy/${string}` | `account/${AccountSuffix}` | `pharmacist/${string}` | `subscriptions/${SubscriptionSuffix}` | `medication/create/${string}` | `medication/all/${'pharma' | 'org'}/${string}` | `medication/${'delete' | 'update'}/${string}`;
...
export type PharmacistDetailsResponse = TholaApiResponse<{ pharmacist: PharmacistDetails; message: string }>
...
export type StripePriceListResponse = TholaApiResponse<{ priceList: Array<StripePrice>; productList: Array<StripeProduct> }>

export type InitializeSubscriptionSessionResponse = TholaApiResponse<{ message: string; paymentUrl: string; }>

export type SubscriptionListResponse = TholaApiResponse<{ subscriptionList: Stripe.Subscription[]; }>

export type CreateMedicationResponse = TholaApiResponse<{ message: string; drugId: string; }>;

export type MedicationDetailsResponse = TholaApiResponse<{ message: string; medication: MedicationDetails; }>;

export type MedicationListResponse = TholaApiResponse<{ message: string; medications: Array<MedicationDetails>; }>
