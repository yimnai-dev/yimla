...
export const drugDosageForm = z.enum(['tablet', 'capsule', 'powder', 'liquid', 'inhalation', 'injection', 'other'], { required_error: 'Dosage form is required', invalid_type_error: 'Invalid dosage form' })
